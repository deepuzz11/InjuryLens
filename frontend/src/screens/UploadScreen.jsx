...
import {
  ...
  RotateCcw, Layers, TrendingUp, Heart,
} from 'lucide-react'
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }}>
            ...
            {!file && (
              <button
                ...
                className="w-full mt-2 py-2.5 rounded-xl glass border border-border-subtle text-sm text-text-secondary hover:text-text-primary hover:border-border-accent transition-all flex items-center justify-center gap-2"
              >
